...
public class PacerGeneratorBackup {
    private int BreathingRate =0;
    private List<PACER> Pacerlist = new ArrayList<PACER>();

    public PacerGeneratorBackup(int BreathingRate, List<PACER> Pacerlist){
    ...
    public static void main(String[] args) {
        ...
        PacerGeneratorBackup pg = new PacerGeneratorBackup(br,ps);
        pg.stepgeneration();
